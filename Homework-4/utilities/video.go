...
type MetaComment struct {
	...
	ReplyComment []ReplyComment  `json:"comments_in_floor" gorm:"-"` //该楼的楼中楼评论
}
...
type VideoInformation struct {
	...
	AuthorId  int
	Author    []VideoAuthorInformation `json:"author" gorm:"-"`
	Common    `json:"common" gorm:"-"`
}
...
//}
//
//func (r Temp) TableName() string {
//	return "likes_videos_comments_relationship"
//}
