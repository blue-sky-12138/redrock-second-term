...
import (
	MySQL2 "SecondTerm/Homework-7/videosRouters/oauth/MySQL"
	jwt2 "SecondTerm/Homework-7/videosRouters/oauth/jwt"
	Redigo "SecondTerm/Homework-7/videosRouters/oauth/redigo"
	"crypto/hmac"
	"crypto/md5"
	"encoding/base64"
	"encoding/json"
